...
class Device:
    ...
    def onMessage(self, data: dict):
        ...
        if data['type'] == 'update':
            ...
            print(f"Device {self._id} updated to {len(self.records)} records")
...
class SyncService:
    ...
    def onMessage(self, data: dict):
        ...
        if data['type'] == 'record':
            ...
            self.devices[dev_id].records.append(data['data'])
            ...
            return {'type': 'update', 'dev_id': dev_id, 'from': dev_from, 'data': self.devices[dev_id].records[dev_from:]}
